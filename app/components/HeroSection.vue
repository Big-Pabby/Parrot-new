       ...
       <div class="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 md:gap-12 min-h-[500px] md:min-h-[600px] lg:min-h-[700px]">
         ...
         <div class="flex flex-col gap-6 md:gap-8 w-full lg:w-6/12">
           <div class="flex flex-col gap-4 md:gap-6">
             <h1 class="font-heading text-4xl sm:text-5xl md:text-[56px] lg:text-[64px] font-bold leading-[1.1] text-black scroll-animate">
        ...
        <!-- Right: Phone Mockup -->
        <div class="relative w-full md:w-5/12 lg:self-end mt-8 lg:mt-0 scroll-animate">
          <img
            src="/images/hero.png"
